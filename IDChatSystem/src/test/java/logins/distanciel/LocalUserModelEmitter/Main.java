...
import project.insa.idchatsystem.logins.local_mode.distanciel.LocalUserModelEmitter;
...
public class Main {
    public static void main(String [] args) {
        ...
        LocalUserModelEmitter emitter = new LocalUserModelEmitter(2100,others);
